...
const POSITIVE: readonly (readonly [string, SecretKind])[] = [
  ...
  ["PIN:\n4471", "secret_value"],
  ["mother's maiden name is O'Brien", "secret_value"],
  ["3782 8224 6310 005 12/28", "card_number"],
  ["3782 8224 6310 005 1234", "card_number"],
  ["security word is sunshine", "secret_value"],
  ["the secret word is sunshine", "secret_value"],
  ["town of birth is Leeds", "secret_value"],
  ["answer to security question: Rex", "secret_value"],
  ["the texted code is 482913", "secret_value"],
  ["my PIN is 44\u200B71", "secret_value"],
  ["if they ask for my password, it's sunshine", "secret_value"],
  ["my password for the portal is sunshine", "secret_value"],
  ["if they want the password say sunshine", "secret_value"],
  ["my password's sunshine", "secret_value"],
  ["maiden name: O'Neil", "secret_value"],
  ["mum's maiden name O'Neill", "secret_value"],
  ["my memorable word is D'Arcy", "secret_value"],
  ["first pet was O'Malley", "secret_value"],
  ["security answer: O'Hara", "secret_value"],
  ["if they ask for my PIN, it's 4471", "secret_value"],
  ["if they ask for my PIN it's 4471", "secret_value"],
  ["if they ask for the password, it's hunter2", "secret_value"],
  ["If they want my password, tell them hunter2", "secret_value"],
  ["PIN - it's 4471", "secret_value"],
  ["PIN no. 4471", "secret_value"],
  ["the PIN for my card is 4471", "secret_value"],
  ["my password for the portal is hunter2", "secret_value"],
  ["password for their site: hunter2", "secret_value"],
  ["4471 is my PIN", "secret_value"],
  ["the memorable word they have is sunshine", "secret_value"],
  ["the bank account number for direct debit is 12345678", "bank_details"],
  ["account number 12 34 56 78", "bank_details"],
  ["sort code for my account is 20.00.00", "bank_details"],
  ["s/c 20-00-00", "bank_details"],
  ["PIN is\n4471", "secret_value"],
...
const FALSE_POSITIVES: readonly string[] = [
  ...
  "password: see letter",
  "password: don't know",
  "memorable word: don't have one",
  "password: won't tell",
  "password: isn't set",
  "surgery account number 12345678",
  "NHS account 12345678",
  "they may ask for a password — say you don't have it",
  "they may ask for your memorable word — tell them to call me",
  "if they ask for the security answer - hang up",
  "they may ask for mother's maiden name: tell them you can't",
  "memorable word: they know I'll call",
  "they'll ask for the password - just say no",
  "they may ask for a PIN at 10:30, say you don't have it",
  "the PIN is 6 digits, I don't have it",
  "PIN reader broken on 14/10/2026",
  "mother's maiden name is a secret",
  "memorable word is a secret",
  "security answer was a guess",
  "place of birth is a village",
  "maiden name was a problem",
  "password is fine",
